...
{
    public partial class RegisterPriceList
    {
        public int RegisterPriceListId { get; set; }
        ...
        public DateTime? ReceivedDateVendor { get; set; }
        ...
        public string IsOtherRevised { get; set; }
